...
import { CalendarDays, Eye, EyeOff, FolderOpen, Gift, Loader2, Plus, Sparkles, User, Users } from "lucide-react";
import { useState } from "react";
import { useForm } from "react-hook-form";
import z from "zod";
import { listCreateSchema } from "../../schemas/list-schemas";
import {
  PresentMultiSelect,
  SelectedPresentsChips,
} from "./present-multi-select";

type FormValues = z.infer<typeof listCreateSchema>;

type ListData = FormValues;
...
export const ListCreateForm = ({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      isForMe: initialValues?.isForMe ?? true,
      presentIds: initialValues?.presentIds || [],
    },
  });
